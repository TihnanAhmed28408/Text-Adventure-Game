...
public class AdventurerGameTest {
    ...
    public void testWelcomeMessageContainsTitle() {
        assertTrue(game.welcomeMessage().contains("Stadium Hunt"));
    }
    ...
    public void testWandaConnectedSouth() {
        ...
        assertTrue(allianz.getShortDescription().contains("Allianz Arena"));
    }
    ...
    public void testAllRoomsReachableFromWanda() {
        ...
        assertTrue(uefaHQ.getShortDescription().contains("UEFA Headquarters"));
    }
}
